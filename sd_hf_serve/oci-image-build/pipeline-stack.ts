...
export class PipelineStack extends Stack {
  ...
  */
  ...
  const base_image_xla_amd_build = new codebuild.Project(this, `ImageXlaAmdBuild`, {
  ...
  base_registry.grantPullPush(base_image_xla_amd_build.grantPrincipal);
  ...
  basebuildpipeline.addStage({
    ...
    actions: [
      ...
      new codepipeline_actions.CodeBuildAction({
        actionName: 'BaseImageXlaAmdBuild',
        input: sourceOutput,
        runOrder: 2,
        project: base_image_xla_amd_build
      }),
    ]
  });
  }
