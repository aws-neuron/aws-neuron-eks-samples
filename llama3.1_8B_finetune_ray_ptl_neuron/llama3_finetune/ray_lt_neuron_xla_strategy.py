# This is an interim class needed to make Ray + PTL work on Trainium. We are working to # include support in Neuron SDK for this scenario in future releases and when that is  # done, this class and it's references will no longer be needed.
